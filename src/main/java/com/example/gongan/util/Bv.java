...
public class Bv {
    ...
    public static String getProjectId(int i) {
        ...
        return "pr" + Base58.encode((Integer.MAX_VALUE) ^ i);
    }

    public static String getTaskId(int i) {
        // i 只要不超过 1491126880, 长度就固定为 6
        return "ta" + Base58.encode((Integer.MAX_VALUE) ^ i);
    }
    public static String getUserId(int i) {
        // i 只要不超过 1491126880, 长度就固定为 6
        return "us" + Base58.encode((Integer.MAX_VALUE) ^ i);
    }
